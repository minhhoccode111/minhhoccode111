...
<!--TODO: finish those courses to put them live-->
<!-- | DSA                 | -                                                                                    | [view](https://github.com/minhhoccode111/data-structures-and-algorithms) | `Python` `Data Structures` `Algorithms` `Discrete Mathematics`                                                                                                                                                                              | -->
<!-- | OSTEP               | -                                                                                    | [view](https://github.com/minhhoccode111/ostep)                          | `C` `Python` `Operating Systems`                                                                                                                                                                                                            | -->
<!-- | Missing Semester    | -                                                                                    | [view](https://github.com/minhhoccode111/missing-semester-mit)           | `Tools` `Bash` `Python` `Git` `Vim`                                                                                                                                                                                                         | -->
...
<!-- |                  | Name                                                                 | Status                                                        | -->
<!-- | ---------------- | -------------------------------------------------------------------- | ------------------------------------------------------------- | -->
<!-- | Development      | [TOP](https://www.theodinproject.com/paths/full-stack-javascript)    | X                                                             | -->
