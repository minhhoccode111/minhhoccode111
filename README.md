...
I kick-started my career in software development with [The Odin Project](https://www.theodinproject.com/paths/full-stack-javascript) and enhanced my craft with a lot of inspiration from [The Primeagen](https://youtu.be/QIyc6NKS5J0?si=j1C9zStlVkyJXa1O)
...
| ------------------- | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Dotfiles            | -                                                                                    | [view](https://github.com/minhhoccode111/dotfiles)                       | `Linux` `Bash` `Git` `Vim` `Kitty` `Alacritty`                                                                                                                                                                                              |
| DSA                 | -                                                                                    | [view](https://github.com/minhhoccode111/data-structures-and-algorithms) | `DSA`                                                                                                                                                                                                                                       |
| OSTEP               | -                                                                                    | [view](https://github.com/minhhoccode111/ostep)                          | `Operating System`                                                                                                                                                                                                                          |
| Missing Semester    | -                                                                                    | [view](https://github.com/minhhoccode111/missing-semester-mit)           | `Linux` `Bash` `Python` `Git` `Vim`                                                                                                                                                                                                         |
| Game Management     | [view](https://game-management-gfffatcbgwexedgm.southeastasia-01.azurewebsites.net/) | [view](https://github.com/minhhoccode111/game-management)                | `C#` `ASP.NET Core` `Razor` `SQL Server` `EF Core` `Bootstrap` `Azure`                                                                                                                                                                      |
...
| CS50x               | -                                                                                    | [view](https://github.com/minhhoccode111/cs50x)                          | `Computer Science` `DSA`                                                                                                                                                                                                                    |
...
- In my free time, I will either:
  - Watch [The Primeagen](https://www.youtube.com/@ThePrimeTimeagen) (He made me a better developer 😆)
...
- LinkedIn: https://www.linkedin.com/in/mhc111/
